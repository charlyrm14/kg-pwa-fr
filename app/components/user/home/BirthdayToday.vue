        ...
        <div class="relative rounded-lg overflow-hidden shadow dark:shadow-none">
            ...
            <div class="bg-white dark:bg-dark-light rounded-lg p-4">
                <div class="flex justify-between items-center">
                    <h2 class="text-gray-700 dark:text-white font-extrabold text-lg md:text-xl inline-flex items-center gap-x-3"> 
                        Cumpleaños de hoy 
                    ...
                    <NuxtLink
                        v-if="todaysBirthdays.length"
                        to="/birthdays" 
                        class="text-fuchsia-500 text-sm md:text-base cursor-pointer"> 
                            Ver todos 
                    </NuxtLink>
                </div>
                <span class="text-gray-600 dark:text-gray-400 text-xs md:text-sm"> 
                    {{ todaysBirthdays.length ? '¡Feliz cumpleaños a nuestros nadadores!' : 'El tablero de festejos está descansando hoy. ¡Mantente atento para no perderte la próxima felicitación!' }} 
                </span>
