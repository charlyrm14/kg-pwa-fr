        ...
        <div class="bg-white dark:bg-dark rounded-2xl shadow-xl w-[85%] max-w-md md:w-4/5 md:max-w-xl mx-4 max-h-[90vh] overflow-y-auto">
            ...
            <div class="my-6 px-6 py-2 space-y-4">
                ...
                <div class="flex justify-center items-center gap-x-4">
                    <div class="bg-gray-100 dark:bg-dark-light rounded-4xl p-1 flex">
                        <div>
                            <input
                                ref="fileInput"
                                type="file"
                                ...
                                @change="onSelect"/>
                            <button 
                                class="bg-white dark:bg-dark-soft dark:text-white shadow dark:shadow-none rounded-4xl px-4 py-1.5 inline-flex items-center gap-x-2 cursor-pointer hover:opacity-75"
                                @click="openPicker"> 
