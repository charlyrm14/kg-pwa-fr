<script setup lang="ts">
    import AvatarProfile from '~/assets/media/training.png'
        ...
        <div class="bg-white dark:bg-dark rounded-2xl shadow-xl w-[85%] max-w-md md:w-4/5 md:max-w-xl mx-4 max-h-[90vh] overflow-y-auto">
            <div class="flex justify-between items-center mb-4 border-b border-gray-200 dark:border-dark-light px-6 py-4">
                ...
                <button 
                    ...
                    @click="$emit('closeSelectProfileImageModal')">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-x-icon lucide-x"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg>
                </button>
            </div>

            <div class="my-2 px-6 py-2 space-y-4">

                <div class="flex justify-start items-center gap-x-4">
                    <div class="dark:bg-dark-light rounded-4xl px-1 py-1.5 flex">
                        <button class="dark:bg-dark-soft dark:text-white rounded-4xl px-4 py-1.5 inline-flex items-center gap-x-2 cursor-pointer hover:opacity-75"> 
                        ...
                        <button class="dark:text-gray-400 px-4 py-1.5 inline-flex items-center gap-x-2 cursor-pointer hover:opacity-75"> 
            ...
            <div class="pb-4">
                <div class="flex justify-center p-4">
                    <div class="border-4 border-blue-500 rounded-full p-1">
                        <img :src="AvatarProfile" alt="Avatar profile" class="rounded-full w-50 h-50 object-cover">
                    </div>
                </div>
            </div>
