    ...
    <div class="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
        <div class="bg-white dark:bg-dark rounded-2xl shadow-xl w-[85%] max-w-md md:w-4/5 md:max-w-xl mx-4 max-h-[90dvh] flex flex-col">
            ...
            <div class="mt-2 px-6 py-2 flex-1 overflow-y-auto">
                <NuxtLink to="/kg-admin/contents/create/news">
                    <div class="bg-gray-100 dark:bg-dark-light rounded-3xl px-4 py-2.5 shadow dark:shadow-none cursor-pointer hover:opacity-75 mb-4">
                ...
                <NuxtLink to="/kg-admin/contents/create/events">
                    <div class="bg-gray-100 dark:bg-dark-light rounded-3xl px-4 py-2.5 shadow dark:shadow-none cursor-pointer hover:opacity-75 mb-4">
                        <div class="flex justify-between items-center">
                            <div class="flex justify-between items-center gap-x-4">
                ...
                <NuxtLink to="/kg-admin/contents/create/tips">
                    <div class="bg-gray-100 dark:bg-dark-light rounded-3xl px-4 py-2.5 shadow dark:shadow-none cursor-pointer hover:opacity-75 mb-4">
                        <div class="flex justify-between items-center">
                            <div class="flex justify-between items-center gap-x-4">
                ...
                <NuxtLink to="/kg-admin/contents/create/nutrition">
