    ...
    <div class="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
        <div class="bg-white dark:bg-dark rounded-2xl shadow-xl w-[85%] max-w-md md:w-4/5 md:max-w-xl mx-4 max-h-[90dvh] flex flex-col">
            ...
            <div class="mt-2 px-6 py-2 flex-1 overflow-y-auto">
                <div @click="goToCreatePage('/kg-admin/contents/create/news')" class="bg-gray-100 dark:bg-dark-light rounded-3xl px-4 py-2.5 shadow dark:shadow-none cursor-pointer hover:opacity-75 mb-4">
                    <div class="flex justify-between items-center">
                        <div class="flex justify-between items-center gap-x-4">
                            ...
                            <div>
                                <h4 class="text-base md:text-xl dark:text-white font-extrabold"> Noticias </h4>
                                <span class="dark:text-gray-400 text-xs md:text-base"> Novedades deportivas </span>
                            </div>
                        </div>
                        <div class="dark:text-gray-400">
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-right-icon lucide-chevron-right"><path d="m9 18 6-6-6-6"/></svg>
                        </div>
                    </div>
                </div>
                <div @click="goToCreatePage('/kg-admin/contents/create/events')" class="bg-gray-100 dark:bg-dark-light rounded-3xl px-4 py-2.5 shadow dark:shadow-none cursor-pointer hover:opacity-75 mb-4">
                    <div class="flex justify-between items-center">
                        <div class="flex justify-between items-center gap-x-4">
                            ...
                            <div>
                                <h4 class="text-base md:text-xl dark:text-white font-extrabold"> Eventos </h4>
                                <span class="dark:text-gray-400 text-xs md:text-base"> Eventos deportivos </span>
                            </div>
                        </div>
                        <div class="dark:text-gray-400">
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-right-icon lucide-chevron-right"><path d="m9 18 6-6-6-6"/></svg>
                ...
                <div @click="goToCreatePage('/kg-admin/contents/create/tips')" class="bg-gray-100 dark:bg-dark-light rounded-3xl px-4 py-2.5 shadow dark:shadow-none cursor-pointer hover:opacity-75 mb-4">
                    <div class="flex justify-between items-center">
                        <div class="flex justify-between items-center gap-x-4">
                            ...
                            <div>
                                <h4 class="text-base md:text-xl dark:text-white font-extrabold"> Consejos </h4>
                                <span class="dark:text-gray-400 text-xs md:text-base"> Consejos para mejorar </span>
                            </div>
                        </div>
                        <div class="dark:text-gray-400">
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-right-icon lucide-chevron-right"><path d="m9 18 6-6-6-6"/></svg>
                ...
                <div @click="goToCreatePage('/kg-admin/contents/create/nutrition')" class="bg-gray-100 dark:bg-dark-light rounded-3xl px-4 py-2.5 shadow dark:shadow-none cursor-pointer hover:opacity-75">
                    <div class="flex justify-between items-center">
                        <div class="flex justify-between items-center gap-x-4">
                            <div class="bg-lime-100 text-lime-500 rounded-2xl p-2 w-12 h-12">
                                <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-utensils-crossed-icon lucide-utensils-crossed"><path d="m16 2-2.3 2.3a3 3 0 0 0 0 4.2l1.8 1.8a3 3 0 0 0 4.2 0L22 8"/><path d="M15 15 3.3 3.3a4.2 4.2 0 0 0 0 6l7.3 7.3c.7.7 2 .7 2.8 0L15 15Zm0 0 7 7"/><path d="m2.1 21.8 6.4-6.3"/><path d="m19 5-7 7"/></svg>
                            </div>
                            <div>
                                <h4 class="text-base md:text-xl dark:text-white font-extrabold"> Nutrición </h4>
                                <span class="dark:text-gray-400 text-xs md:text-base"> Salud alimenticia </span>
                            </div>
                        </div>
                        <div class="dark:text-gray-400">
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-right-icon lucide-chevron-right"><path d="m9 18 6-6-6-6"/></svg>
