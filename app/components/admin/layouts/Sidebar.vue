                ...
                <ul class="space-y-2">
                    <li>
                        <NuxtLink 
                            ...
                            :class="route.path === '/kg-admin' ? 'bg-gray-100 dark:bg-dark-soft text-blue-500 font-bold' : 'text-gray-400'">
                    ...
                    <li>
                        <NuxtLink 
                            ...
                            class="flex items-center p-2 rounded-lg hover:text-blue-500 transition"
                            :class="route.path === '/kg-admin/contents' ? 'bg-gray-100 dark:bg-dark-soft text-blue-500 font-bold' : 'text-gray-400'">
                    ...
                    <li>
                        <NuxtLink 
                            ...
                            class="flex items-center p-2 rounded-lg hover:text-blue-500 transition"
                            :class="route.path === '/kg-admin/payments' ? 'bg-gray-100 dark:bg-dark-soft text-blue-500 font-bold' : 'text-gray-400'">
                    ...
                    <li>
                        <NuxtLink 
                            ...
                            class="flex items-center p-2 rounded-lg hover:text-blue-500 transition"
                            :class="route.path === '/kg-admin/attendances' ? 'bg-gray-100 dark:bg-dark-soft text-blue-500 font-bold' : 'text-gray-400'">
                    ...
                    <li>
                        <NuxtLink 
                            to="/kg-admin/users" 
                            class="flex items-center p-2 rounded-lg hover:text-blue-500 transition"
                            :class="route.path === '/kg-admin/users' ? 'bg-gray-100 dark:bg-dark-soft text-blue-500 font-bold' : 'text-gray-400'">
