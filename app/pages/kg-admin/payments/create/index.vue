<script setup lang="ts">
    ...
    import { useAlert, getTodayDate } from '#imports';
    import type { CreatePaymentPayload } from '~~/shared/types/Payment';
    import { useForm } from 'vee-validate';
    import { newPaymentSchema } from '~/validations/payments/new-payment';
    ...
    const { defineField,  handleSubmit,  errors} = useForm<CreatePaymentPayload>({
        initialValues: {
            payment_type_id: 1,
    ...
    const onSubmit = handleSubmit(async values => {
        try {
            ...
            const payload: CreatePaymentPayload = {
                ...values,
                user_uuid: paymentOwner.value === 'general'
                    ? null 
                    : userStore?.userLookUp 
                        ? userStore?.userLookUp.uuid
                        : null
            }
