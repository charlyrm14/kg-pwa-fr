                        ...
                        <div class="bg-white dark:bg-dark-light flex flex-col-reverse md:flex-col rounded-lg">
                            ...
                            <div class="border-b border-gray-200 dark:border-dark-extralight p-4">
                                ...
                                <div v-if="eventContent">
                                    <div class="mt-3">
                                        <label for="start_date" class="text-gray-500 dark:text-gray-300 font-bold"> Fecha de inicio de evento </label>
                                        <input 
                                            type="datetime-local"
                                            id="start_date"
                                            name="start_date"
                                    ...
                                    <div class="mt-3">
                                        <label for="end_date" class="text-gray-500 dark:text-gray-300 font-bold"> Fecha fin de evento </label>
                                        <input 
                                            type="datetime-local"
                                            id="end_date"
                                            name="end_date"
                                    ...
                                    <div class="mt-3">
                                        <label for="location" class="text-gray-500 dark:text-gray-300 font-bold"> Ubicación </label>
                                        <input 
                                            type="text"
                                            id="location"
                                            name="location"
