<script setup lang="ts">
    ...
    import { newTipSchema } from '~/validations/contents/new-tip.schema';
...
<template>
    <section class="md:px-5">
        ...
        <section>
            <Breadcrumb
                heading="Creación contenido - Tips (consejos)"
                primary-section="Contenidos"
                primary-link="/kg-admin/contents"
                secondary-section="Crear Tips (consejos)"/>
        </section>
