...
export const MOCK_CONTENT_LIST: PaginationContent<Content> = {
    ...
    data: [
        {
            title: "¡Épico 2! Los 'Dragones' Rompen Récord y Aseguran el Liderato en un Partido No Apto para Cardiacos",
            ...
            created_at: "2025-11-13T06:00:00.000000Z",
            updated_at: "2025-11-13T06:00:00.000000Z",
            author: "unknown",
            type: "NEWS",
            status: "PUBLISHED",
            event: null
        },
        {
            ...
            event: {
                ...
                start_date: "2026-04-26 09:00:00",
                end_date: null
            }
        }
    ],
