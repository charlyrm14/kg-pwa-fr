...
export const MOCK_CONTENT_LIST: PaginationContent<Content> = {
    ...
    data: [
        ...
        {
            title: "Mejora tu alineación y respiración para nadar más eficiente",
        ...
        {
            title: "Alimenta tu energía con comidas equilibradas antes y después del entrenamiento",
        ...
        {
            title: "Récord histórico en la final de natación: la nueva promesa del deporte sorprende al mundo",
        ...
        {
            title: "Mejora tu Propulsión con un Mejor Batido de Piernas",
        ...
        {
            title: "Mantén un Balance Óptimo de Energía",
